...
export const Footer = () => {
  ...
  return (
    <footer className="w-full py-12 px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32 2xl:px-40" style={{ backgroundColor: '#FCFAF7' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="flex flex-wrap justify-center items-center gap-8 sm:gap-12 md:gap-16 mb-8"
        >
          {footerLinks.map((link, index) => (
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              className="transition-colors duration-300 text-sm sm:text-base font-medium"
